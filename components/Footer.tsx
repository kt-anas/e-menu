            ...
            <div className="container mx-auhref px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    {/* <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/templates" className="text-gray-600 hover:text-menu-primary">Templates</Link></li>
                    ...
                    {/* <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/careers" className="text-gray-600 hover:text-menu-primary">Careers</Link></li>
                ...
                <div className="border-t border-gray-200 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
                    <div className="text-gray-500 mb-4 md:mb-0">
                        &copy;{new Date().getFullYear()} emenulab.All rights reserved.
                    </div>

                    <div className="flex gap-6">
                        <a href="#" className="text-gray-500 hover:text-menu-primary">
